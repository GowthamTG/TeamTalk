...
meetConversationsModel.getAllMeetsWithIds = (userId) => {
  return collection
...
meetConversationsModel.createMeet = (meetData) => {
  meetData.roomId = getSaltAndHash();
...
module.exports = meetConversationsModel;
